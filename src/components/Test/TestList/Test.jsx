...
const Test = (props) => {
  ...
  useEffect(() => {
     fetch('http://127.0.0.1:8000/knowlege_test/quiz/')
  ...
  return (
    ...
    <button className={styles.prevQ} onClick={prevBtnClicked}><img src={arrowPrevious} alt="Previous"/></button>
    <button className={styles.nextQ} onClick={nextBtnClicked}><img src={arrowNext} alt="Next"/></button>
